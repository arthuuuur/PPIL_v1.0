...
public:
	...
	*
	* @return {Shape*}  : v1 new segment with applied translation
	*/
	...
	*
	* @return {Shape*}  : v1 new segment with applied homothety
	*/
	...
	*
	* @return {Shape*}  : v1 new segment with applied rotation
	*/
